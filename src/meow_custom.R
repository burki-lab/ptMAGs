...
##------------------------------------------------------------------------------
## MEOW (MAMMaL Extension Over Whole-alignments) - adds Entropy, Upper/Lower partitions, Invariable flag, and includes low rates -- CUSTOM VERSION for Mahwash Jamy
